...
- ### Arrays
    - [ ] About Arrays:
    	- [Arrays CS50 Harvard University](https://www.youtube.com/watch?v=tI_tIZFyKBw&t=3009s) :white_check_mark:
        - [Arrays (video)](https://www.coursera.org/lecture/data-structures/arrays-OsBSF) 
        - [UC Berkeley CS61B - Linear and Multi-Dim Arrays (video)](https://archive.org/details/ucberkeley_webcast_Wp8oiO_CZZE) (Start watching from 15m 32s) :white_check_mark:
        - [Dynamic Arrays (video)](https://www.coursera.org/lecture/data-structures/dynamic-arrays-EwbnV) :white_check_mark:
...
- ### Queue
    ...
    - [x] Implement using linked-list, with tail pointer:
        ...
        - empty()
        - my implementation [here](https://github.com/Faye-yufan/build-data-structure/blob/main/src/MyQueueLl.java)
    - [x] Implement using fixed-sized array:
        - enqueue(value) - adds item at end of available storage
        - dequeue() - returns value and removes least recently added element
        - empty()
        - full()
        - my implementation [here](https://github.com/Faye-yufan/build-data-structure/blob/main/src/MyQueueArr.java)
    - [x] Cost:
        - a bad implementation using linked list where you enqueue at head and dequeue at tail would be O(n)
            because you'd need the next to last element, causing a full traversal each dequeue
        - enqueue: O(1) (amortized, linked list and array [probing])
        - dequeue: O(1) (linked list and array)
        - empty: O(1) (linked list and array) define a `size` in the class?
